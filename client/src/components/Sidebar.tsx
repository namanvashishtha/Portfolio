...
const Sidebar: FC<SidebarProps> = ({ activeSection }) => {
  ...
  return (
<aside className="md:w-28 lg:w-32 dark-card fixed md:relative z-50 transition-all duration-300 top-0 left-0 h-screen md:min-h-screen hidden md:flex flex-col items-center justify-between py-8">
